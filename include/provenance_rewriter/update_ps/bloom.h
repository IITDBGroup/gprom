...
extern Bloom *createBloomFilter();
// extern int bloom_init2(struct bloom * bloom, unsigned int entries, double error);
extern int bloom_init2(Bloom *bloom, unsigned int entries, double error);
...
extern int bloom_init(Bloom * bloom, int entries, double error);
...
extern int bloom_check(Bloom * bloom, const void * buffer, int len);
...
extern int bloom_add(Bloom * bloom, const void * buffer, int len);
...
extern void bloom_print(Bloom * bloom);
...
extern void bloom_free(Bloom * bloom);
...
extern int bloom_reset(Bloom * bloom);
 ...
 *
 */
// extern int bloom_save(struct bloom * bloom, char * filename);
extern int bloom_save(Bloom * bloom, char * filename);
 ...
 *
 */
// extern int bloom_load(struct bloom * bloom, char * filename);
extern int bloom_load(Bloom * bloom, char * filename);
 ...
 *
 */
// extern int bloom_merge(struct bloom * bloom_dest, struct bloom * bloom_src);
extern int bloom_merge(Bloom * bloom_dest, Bloom * bloom_src);
 ...
 *
 */
extern const char * bloom_version();
