...
// TIMER FOR OPERATORs
#define INCREMENTAL_UPDATE_TIMER "module - update provenance sketch - incremental update total cost"
#define INCREMENTAL_UPDATE_ACTUAL_TIMER "module - update provenance sketch - incremental update all steps"
