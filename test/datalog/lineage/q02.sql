CREATE TABLE rtpcq02 AS SELECT  DISTINCT F0.S_ACCOUNT_BAL AS A0, F0.S_NAME AS A1, F0.N_NAME AS A2, F0.P_KEY AS A3, F0.S_COST AS A4, F0.P_MANU AS A5, F0.S_ADDR AS A6, F0.S_PHONE AS A7, F0.S_COMMENT AS A8
FROM ((
