-- Returns ...
CREATE OR REPLACE FUNCTION _z_op_sub(lhs REAL[], rhs REAL[]) RETURNS REAL[] AS
$$
    DECLARE
        res REAL[];
    BEGIN
...
-- Examples:
-- SELECT z_sub(ARRAY[1,1,1], ARRAY[1,2,2]);
-- SELECT z_sub(ARRAY[1,2,1,5,3], ARRAY[1,1,1,2,2,7,7]);
